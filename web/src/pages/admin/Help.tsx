  ...
  return (
    <div style={{ display: 'flex', gap: '2rem', height: '100%', paddingBottom: '2rem' }}>
      ...
      <div className="admin-glass-card" style={{ width: '280px', flexShrink: 0, padding: '1.5rem', display: 'flex', flexDirection: 'column', alignSelf: 'flex-start', position: 'sticky', top: 0 }}>
        <h3 style={{ fontSize: '1.2rem', color: 'var(--text-main)', marginBottom: '1.5rem', paddingBottom: '1rem', borderBottom: '1px solid var(--border-color)' }}>
          Help Center
        </h3>
      ...
      <div className="admin-glass-card custom-scrollbar" style={{ flex: 1, padding: '2.5rem', overflowY: 'auto' }}>
        ...
        <div style={{ marginBottom: '3rem' }}>
          <h1 style={{ fontSize: '2.5rem', fontWeight: 800, color: 'var(--text-main)', marginBottom: '0.5rem' }}>Admin Documentation</h1>
        ...
        <section id="overview" style={{ marginBottom: '4rem', paddingTop: '1rem' }}>
          <h2 style={{ fontSize: '1.8rem', color: 'var(--text-main)', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
        ...
        <section id="orders" style={{ marginBottom: '4rem', paddingTop: '1rem' }}>
          ...
          <h4 style={{ color: 'var(--text-main)', fontSize: '1.1rem', marginBottom: '1rem' }}>Understanding Order Statuses</h4>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1rem', marginBottom: '2rem' }}>
            <div style={{ background: 'var(--bg-darker)', padding: '1rem', borderRadius: '8px', borderLeft: '4px solid #f59e0b' }}>
              <strong style={{ color: '#f59e0b', display: 'block', marginBottom: '0.25rem' }}>PENDING</strong>
              <span style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>A new order has been created by a customer but no rider has been assigned yet. Action required from dispatch.</span>
            </div>
            <div style={{ background: 'var(--bg-darker)', padding: '1rem', borderRadius: '8px', borderLeft: '4px solid var(--primary)' }}>
              <strong style={{ color: 'var(--primary)', display: 'block', marginBottom: '0.25rem' }}>ASSIGNED</strong>
              <span style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>A dispatcher has allocated a rider to the order. The rider should be heading to the pickup location.</span>
            </div>
            <div style={{ background: 'var(--bg-darker)', padding: '1rem', borderRadius: '8px', borderLeft: '4px solid #3b82f6' }}>
              <strong style={{ color: '#3b82f6', display: 'block', marginBottom: '0.25rem' }}>PICKED_UP</strong>
              <span style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>The rider has collected the package and is currently en route to the dropoff location.</span>
            </div>
            <div style={{ background: 'var(--bg-darker)', padding: '1rem', borderRadius: '8px', borderLeft: '4px solid #10b981' }}>
              <strong style={{ color: '#10b981', display: 'block', marginBottom: '0.25rem' }}>DELIVERED</strong>
              <span style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>The package has successfully reached its destination and the transaction is closed.</span>
            </div>
            <div style={{ background: 'var(--bg-darker)', padding: '1rem', borderRadius: '8px', borderLeft: '4px solid #ef4444' }}>
              <strong style={{ color: '#ef4444', display: 'block', marginBottom: '0.25rem' }}>CANCELLED</strong>
              <span style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>The order was aborted either by the customer or the admin.</span>
            </div>
          </div>
          
          <h4 style={{ color: 'var(--text-main)', fontSize: '1.1rem', marginBottom: '1rem' }}>Dispatch Workflow</h4>
        ...
        <section id="colors" style={{ marginBottom: '4rem', paddingTop: '1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div>
                <strong style={{ color: 'var(--text-main)' }}>Emerald Green (#10b981) - "Positive / Active"</strong>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div>
                <strong style={{ color: 'var(--text-main)' }}>Neon Purple (Brand Primary) - "Neutral / Idle"</strong>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div>
                <strong style={{ color: 'var(--text-main)' }}>Amber Orange (#f59e0b) - "Pending / Warning"</strong>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div>
                <strong style={{ color: 'var(--text-main)' }}>Crimson Red (#ef4444) - "Negative / Critical"</strong>
        ...
        <section id="fleet" style={{ marginBottom: '4rem', paddingTop: '1rem' }}>
          ...
          <div style={{ background: 'var(--bg-darker)', border: '1px solid var(--border-color)', borderRadius: '1rem', padding: '1.5rem' }}>
            <h4 style={{ color: 'var(--text-main)', marginBottom: '0.5rem', fontSize: '1.1rem' }}>2. Riders Management (HR Portal)</h4>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', margin: 0, lineHeight: '1.5' }}>
        ...
        <section id="admin-profile" style={{ marginBottom: '4rem', paddingTop: '1rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
            <div style={{ background: 'var(--bg-darker)', padding: '1.5rem', borderRadius: '1rem', border: '1px solid var(--border-color)' }}>
              <h4 style={{ color: 'var(--text-main)', marginBottom: '0.5rem' }}>Profile Management</h4>
            ...
            <div style={{ background: 'var(--bg-darker)', padding: '1.5rem', borderRadius: '1rem', border: '1px solid var(--border-color)' }}>
              <h4 style={{ color: 'var(--text-main)', marginBottom: '0.5rem' }}>Security Credentials</h4>
        ...
        <section id="settings" style={{ marginBottom: '4rem', paddingTop: '1rem' }}>
          ...
          <div style={{ background: 'var(--bg-darker)', border: '1px solid var(--border-color)', borderRadius: '1rem', padding: '1.5rem' }}>
            <h4 style={{ color: 'var(--text-main)', marginBottom: '1rem', fontSize: '1.1rem' }}>Adjusting Delivery Pricing</h4>
            ...
            <ul style={{ color: 'var(--text-muted)', fontSize: '0.85rem', lineHeight: '1.6', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
